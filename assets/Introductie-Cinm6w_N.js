import{j as n,r as a}from"./index-DoM-sG5C.js";const o="/web2-cursus-2026/images/fireworks.gif";function c(){let e=25;const t=document.getElementById("timer"),r=document.getElementById("fireworks"),s=setInterval(function(){e--,t.textContent=e,e<=0&&(clearInterval(s),t.classList.add("hidden"),r.classList.remove("hidden"))},1e3)}function i(e){const t={p:"p",...e.components};return n.jsxs(n.Fragment,{children:[(a.useEffect(()=>{const r=c();return()=>r?.()},[]),null),`
