...
`,e.jsx("img",{src:i,alt:"Cmd",className:"img-fluid my-3"}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"hljs language-shell",children:`    node -v
`})}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"hljs language-shell",children:`    npm -v
`})}),`
...
`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"hljs language-shell",children:`    winget install OpenJS.NodeJS.LTS
`})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"macOS (Homebrew)"}),`
`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"hljs language-shell",children:`    brew install node
`})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Linux (apt)"}),`
`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"hljs language-shell",children:`    sudo apt update\r
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"hljs language-shell",children:`    node -v\r
    npm -v
`})}),`
...
`]})]})}function m(s={}){const{wrapper:n}=s.components||{};return n?e.jsx(n,{...s,children:e.jsx(r,{...s})}):r(s)}export{m as default};
