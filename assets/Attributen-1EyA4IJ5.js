import{j as n,r as d}from"./index-DAnO9JXN.js";const o="/web2-cursus-2026/images/worthy.png";function r(){const a=document.querySelector("#changing-img");if(a.getAttribute("src")=="https://upload.wikimedia.org/wikipedia/commons/d/db/Margaret_Hamilton_-_restoration.jpg"){const e=document.getElementById("margaret-info");e&&e.remove();const s=document.createElement("p");s.id="margaret-info",s.innerHTML=`
