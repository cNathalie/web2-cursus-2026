import{j as e}from"./index-DoM-sG5C.js";function l(s){const n={a:"a",code:"code",em:"em",h2:"h2",hr:"hr",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:`en Node heeft veel properties. Je kan deze bekijken via de Developer Tools in je browser,\r
in het tabblad "Elements" en subtabblad "Properties". We bespreken de meest gebruikte:`}),`
`,e.jsx(n.hr,{}),`
`,e.jsx("div",{className:"inline-dynamic-example",children:e.jsx("div",{id:"id1",children:"Hello, world!"})}),`
...
`,e.jsx(n.span,{className:"hljs-keyword",children:"const"})," node = ",e.jsx(n.span,{className:"hljs-variable language_",children:"document"}),".",e.jsx(n.span,{className:"hljs-title function_",children:"querySelector"}),"(",e.jsx(n.span,{className:"hljs-string",children:'"#id1"'}),`);\r
...
`]}),`
`,e.jsx("div",{className:"inline-dynamic-example",children:e.jsx("div",{id:"id2",children:"Hello, world!"})}),`
`,e.jsx(n.pre,{children:e.jsxs(n.code,{className:"hljs language-js",children:[e.jsx(n.span,{className:"hljs-comment",children:"// We halen deze div op "}),`\r
`,e.jsx(n.span,{className:"hljs-keyword",children:"const"})," node = ",e.jsx(n.span,{className:"hljs-variable language_",children:"document"}),".",e.jsx(n.span,{className:"hljs-title function_",children:"querySelector"}),"(",e.jsx(n.span,{className:"hljs-string",children:"'#id2'"}),`); \r
`,e.jsx(n.span,{className:"hljs-variable language_",children:"console"}),".",e.jsx(n.span,{className:"hljs-title function_",children:"log"}),"(node.",e.jsx(n.span,{className:"hljs-property",children:"nodeValue"}),`);
`]})}),`
`,e.jsxs(n.h2,{id:"parentnode",children:[e.jsx(n.code,{children:"parentNode"}),e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#parentnode",children:e.jsx(n.span,{className:"icon icon-link"})})]}),`
`,e.jsx(n.p,{children:"De ouder node van deze node."}),`
`,e.jsx("div",{className:"inline-dynamic-example",children:e.jsx("div",{id:"id3",children:"Hello, world!"})}),`
`,e.jsx(n.pre,{children:e.jsxs(n.code,{className:"hljs language-js",children:[e.jsx(n.span,{className:"hljs-comment",children:"// We halen deze div op"}),`\r
`,e.jsx(n.span,{className:"hljs-keyword",children:"const"})," node = ",e.jsx(n.span,{className:"hljs-variable language_",children:"document"}),".",e.jsx(n.span,{className:"hljs-title function_",children:"querySelector"}),"(",e.jsx(n.span,{className:"hljs-string",children:'"#id3"'}),`);\r
