...
`,e.jsx(s.span,{className:"hljs-keyword",children:"const"})," ",e.jsx(s.span,{className:"hljs-title function_",children:"addEventListeners"})," = (",e.jsx(s.span,{className:"hljs-params",children:"checkboxList, buttonList"}),`) => {\r
...
`,e.jsx(s.span,{className:"hljs-keyword",children:"const"})," ",e.jsx(s.span,{className:"hljs-title function_",children:"updateCounter"})," = (",e.jsx(s.span,{className:"hljs-params"}),`) => {\r
...
\r
  ...
  `,e.jsx(s.span,{className:"hljs-keyword",children:"for"})," (",e.jsx(s.span,{className:"hljs-keyword",children:"let"})," i = ",e.jsx(s.span,{className:"hljs-number",children:"0"}),"; i < checkboxes.",e.jsx(s.span,{className:"hljs-property",children:"length"}),`; i++) {\r
    `,e.jsx(s.span,{className:"hljs-keyword",children:"if"})," (checkboxes[i].",e.jsx(s.span,{className:"hljs-property",children:"checked"}),`) {\r
      completedCount++;\r
    }\r
  }\r
\r
  `,e.jsx(s.span,{className:"hljs-comment",children:"// Tel totaal aantal items"}),`\r
  `,e.jsx(s.span,{className:"hljs-keyword",children:"const"})," totalCount = checkboxes.",e.jsx(s.span,{className:"hljs-property",children:"length"}),`;\r
\r
...
`,e.jsx(s.span,{className:"hljs-comment",children:"// ========================================"}),`\r
`,e.jsx(s.span,{className:"hljs-keyword",children:"const"})," ",e.jsx(s.span,{className:"hljs-title function_",children:"handleAddTodo"})," = (",e.jsx(s.span,{className:"hljs-params"}),`) => {\r
  `,e.jsx(s.span,{className:"hljs-keyword",children:"const"})," newTodoInput = ",e.jsx(s.span,{className:"hljs-variable language_",children:"document"}),".",e.jsx(s.span,{className:"hljs-title function_",children:"getElementById"}),"(",e.jsx(s.span,{className:"hljs-string",children:'"newTodoInput"'}),`);\r
...
\r
  `,e.jsx(s.span,{className:"hljs-keyword",children:"const"})," newInput = ",e.jsx(s.span,{className:"hljs-variable language_",children:"document"}),".",e.jsx(s.span,{className:"hljs-title function_",children:"createElement"}),"(",e.jsx(s.span,{className:"hljs-string",children:'"input"'}),`);\r
  newInput.`,e.jsx(s.span,{className:"hljs-property",children:"type"})," = ",e.jsx(s.span,{className:"hljs-string",children:'"checkbox"'}),`;\r
  newInput.`,e.jsx(s.span,{className:"hljs-property",children:"classList"}),".",e.jsx(s.span,{className:"hljs-title function_",children:"add"}),"(",e.jsx(s.span,{className:"hljs-string",children:'"checkbox"'}),`);\r
\r
  `,e.jsx(s.span,{className:"hljs-keyword",children:"const"})," newSpan = ",e.jsx(s.span,{className:"hljs-variable language_",children:"document"}),".",e.jsx(s.span,{className:"hljs-title function_",children:"createElement"}),"(",e.jsx(s.span,{className:"hljs-string",children:'"span"'}),`);\r
  newSpan.`,e.jsx(s.span,{className:"hljs-property",children:"classList"}),".",e.jsx(s.span,{className:"hljs-title function_",children:"add"}),"(",e.jsx(s.span,{className:"hljs-string",children:'"todo-text"'}),`);\r
  newSpan.`,e.jsx(s.span,{className:"hljs-property",children:"textContent"}),` = newTodoText;\r
\r
  `,e.jsx(s.span,{className:"hljs-keyword",children:"const"})," newBtn = ",e.jsx(s.span,{className:"hljs-variable language_",children:"document"}),".",e.jsx(s.span,{className:"hljs-title function_",children:"createElement"}),"(",e.jsx(s.span,{className:"hljs-string",children:'"button"'}),`);\r
  newBtn.`,e.jsx(s.span,{className:"hljs-property",children:"classList"}),".",e.jsx(s.span,{className:"hljs-title function_",children:"add"}),"(",e.jsx(s.span,{className:"hljs-string",children:'"delete-btn"'}),`);\r
  newBtn.`,e.jsx(s.span,{className:"hljs-property",children:"innerText"})," = ",e.jsx(s.span,{className:"hljs-string",children:'"X"'}),`;\r
\r
  newLi.`,e.jsx(s.span,{className:"hljs-title function_",children:"appendChild"}),`(newInput);\r
  newLi.`,e.jsx(s.span,{className:"hljs-title function_",children:"appendChild"}),`(newSpan);\r
  newLi.`,e.jsx(s.span,{className:"hljs-title function_",children:"appendChild"}),`(newBtn);\r
\r
  `,e.jsx(s.span,{className:"hljs-comment",children:"// We kunnen dit in principe ook doen met innerHTML in te vullen met een HTML string,"}),`\r
  `,e.jsx(s.span,{className:"hljs-comment",children:"// maar dit is een duurdere operatie. We verkiezen het aanmaken van nieuwe elementen"}),`\r
  `,e.jsx(s.span,{className:"hljs-comment",children:"// zoals hierboven."}),`\r
  `,e.jsx(s.span,{className:"hljs-comment",children:"// newLi.innerHTML = `"}),`\r
  `,e.jsx(s.span,{className:"hljs-comment",children:'//         <input type="checkbox" class="checkbox">'}),`\r
  `,e.jsx(s.span,{className:"hljs-comment",children:'//         <span class="todo-text">${newTodoText}</span>'}),`\r
  `,e.jsx(s.span,{className:"hljs-comment",children:'//         <button class="delete-btn">X</button>'}),`\r
  `,e.jsx(s.span,{className:"hljs-comment",children:"//     `;"}),`\r
\r
...
\r
`,e.jsx(s.span,{className:"hljs-keyword",children:"const"})," ",e.jsx(s.span,{className:"hljs-title function_",children:"handleCheckbox"})," = (",e.jsx(s.span,{className:"hljs-params",children:"checkbox"}),`) => {\r
...
\r
  ...
  `,e.jsx(s.span,{className:"hljs-keyword",children:"if"})," (checkbox.",e.jsx(s.span,{className:"hljs-property",children:"checked"}),`) {\r
...
\r
`,e.jsx(s.span,{className:"hljs-keyword",children:"const"})," ",e.jsx(s.span,{className:"hljs-title function_",children:"handleDelete"})," = (",e.jsx(s.span,{className:"hljs-params",children:"button"}),`) => {\r
  `,e.jsx(s.span,{className:"hljs-comment",children:"// Haal het parent <li> element op"}),`\r
...
\r
`,e.jsx(s.span,{className:"hljs-variable language_",children:"window"}),".",e.jsx(s.span,{className:"hljs-title function_",children:"addEventListener"}),"(",e.jsx(s.span,{className:"hljs-string",children:'"load"'}),`, setup);
`]})}),`
`,e.jsx(s.hr,{}),`
