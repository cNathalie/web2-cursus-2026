import{j as e}from"./index-3BjEGx3K.js";function a(n){const s={a:"a",br:"br",code:"code",em:"em",h2:"h2",hr:"hr",p:"p",pre:"pre",span:"span",strong:"strong",...n.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.p,{children:["De eerste timer functie is de ",e.jsx(s.code,{children:"setTimeout"}),"."]}),`
`,e.jsx(s.hr,{}),`
