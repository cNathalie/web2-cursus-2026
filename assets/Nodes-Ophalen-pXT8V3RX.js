...
`,e.jsx(s.span,{className:"hljs-keyword",children:"const"})," elements = ",e.jsx(s.span,{className:"hljs-variable language_",children:"document"}),".",e.jsx(s.span,{className:"hljs-title function_",children:"getElementsByTagName"}),"(",e.jsx(s.span,{className:"hljs-string",children:'"h2"'}),`);\r
\r
