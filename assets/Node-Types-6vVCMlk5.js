...
`,e.jsx("div",{className:"inline-dynamic-example",children:e.jsx("div",{id:"my-div",children:"Hallo wereld"})}),`
...
`,e.jsxs(s.p,{children:["Hieronder vind je enkele realistische voorbeelden waar ",e.jsx(s.code,{children:"nodeType"}),` handig is in de praktijk:\r
(Niet uitvoerbaar in de console, maar bedoeld als illustratie van het concept)`]}),`
