import{j as e}from"./index-DAnO9JXN.js";function a(n){const s={a:"a",br:"br",code:"code",em:"em",h2:"h2",hr:"hr",p:"p",pre:"pre",span:"span",strong:"strong",...n.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.p,{children:["De tweede timer functie is ",e.jsx(s.code,{children:"setInterval"}),"."]}),`
`,e.jsx(s.hr,{}),`
