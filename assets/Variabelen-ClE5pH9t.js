...
`,e.jsx(n.pre,{children:e.jsxs(n.code,{className:"hljs language-javascript",children:[e.jsx(n.span,{className:"hljs-keyword",children:"let"})," x = ",e.jsx(n.span,{className:"hljs-number",children:"5"}),`;
`]})}),`
...
Bijvoorbeeld:`}),`
`,e.jsx(n.pre,{children:e.jsxs(n.code,{className:"hljs language-javascript",children:[e.jsx(n.span,{className:"hljs-keyword",children:"let"}),` y;
`]})}),`
...
`]}),`
`,e.jsx(n.pre,{children:e.jsxs(n.code,{className:"hljs language-javascript",children:[e.jsx(n.span,{className:"hljs-keyword",children:"let"})," x = ",e.jsx(n.span,{className:"hljs-number",children:"5"}),`;\r
`,e.jsx(n.span,{className:"hljs-variable language_",children:"console"}),".",e.jsx(n.span,{className:"hljs-title function_",children:"log"}),`(x);\r
\r
x = `,e.jsx(n.span,{className:"hljs-number",children:"10"}),`;\r
`,e.jsx(n.span,{className:"hljs-variable language_",children:"console"}),".",e.jsx(n.span,{className:"hljs-title function_",children:"log"}),`(x);\r
\r
x = `,e.jsx(n.span,{className:"hljs-string",children:'"Hello"'}),`;\r
...
`]}),`
`,e.jsx(n.pre,{children:e.jsxs(n.code,{className:"hljs language-javascript",children:[e.jsx(n.span,{className:"hljs-keyword",children:"let"}),` y;\r
`,e.jsx(n.span,{className:"hljs-variable language_",children:"console"}),".",e.jsx(n.span,{className:"hljs-title function_",children:"log"}),`(y);
`]})}),`
...
`,e.jsx(n.pre,{children:e.jsxs(n.code,{className:"hljs language-javascript",children:[e.jsx(n.span,{className:"hljs-keyword",children:"const"})," ",e.jsx(n.span,{className:"hljs-variable constant_",children:"PI"})," = ",e.jsx(n.span,{className:"hljs-number",children:"3.14"}),`;
`]})}),`
...
`,e.jsx(n.p,{children:"Bijvoorbeeld:"}),`
`,e.jsx(n.pre,{children:e.jsxs(n.code,{className:"hljs language-javascript",children:[e.jsx(n.span,{className:"hljs-keyword",children:"const"})," ",e.jsx(n.span,{className:"hljs-variable constant_",children:"PI"})," = ",e.jsx(n.span,{className:"hljs-number",children:"3.14"}),`;\r
`,e.jsx(n.span,{className:"hljs-variable constant_",children:"PI"})," = ",e.jsx(n.span,{className:"hljs-number",children:"3.14159"}),`;
`]})}),`
...
Bijvoorbeeld:`]}),`
`,e.jsx(n.pre,{children:e.jsxs(n.code,{className:"hljs language-javascript",children:[e.jsx(n.span,{className:"hljs-keyword",children:"var"})," a = ",e.jsx(n.span,{className:"hljs-number",children:"5"}),`;\r
`,e.jsx(n.span,{className:"hljs-variable language_",children:"console"}),".",e.jsx(n.span,{className:"hljs-title function_",children:"log"}),`(a);\r
\r
`,e.jsx(n.span,{className:"hljs-keyword",children:"var"})," a = ",e.jsx(n.span,{className:"hljs-number",children:"10"}),`;\r
`,e.jsx(n.span,{className:"hljs-variable language_",children:"console"}),".",e.jsx(n.span,{className:"hljs-title function_",children:"log"}),`(a);
`]})}),`
...
`,e.jsx(n.pre,{children:e.jsxs(n.code,{className:"hljs language-javascript",children:[e.jsx(n.span,{className:"hljs-keyword",children:"var"})," a = ",e.jsx(n.span,{className:"hljs-number",children:"5"}),`;\r
\r
`,e.jsx(n.span,{className:"hljs-keyword",children:"function"})," ",e.jsx(n.span,{className:"hljs-title function_",children:"example"}),"(",e.jsx(n.span,{className:"hljs-params"}),`) {\r
  `,e.jsx(n.span,{className:"hljs-keyword",children:"var"})," a = ",e.jsx(n.span,{className:"hljs-number",children:"10"}),`;\r
  `,e.jsx(n.span,{className:"hljs-variable language_",children:"console"}),".",e.jsx(n.span,{className:"hljs-title function_",children:"log"}),`(a);\r
}\r
\r
`,e.jsx(n.span,{className:"hljs-title function_",children:"example"}),`();\r
\r
`,e.jsx(n.span,{className:"hljs-variable language_",children:"console"}),".",e.jsx(n.span,{className:"hljs-title function_",children:"log"}),`(a);
`]})}),`
...
`,e.jsx("img",{src:r,alt:"Var in Prison",className:"img-fluid my-3"})]})}function i(a={}){const{wrapper:n}=a.components||{};return n?e.jsx(n,{...a,children:e.jsx(s,{...a})}):s(a)}export{i as default};
