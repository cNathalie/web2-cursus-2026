import{j as e}from"./index-Dwhqwc41.js";const s="/web2-cursus-2026/images/timezones.png";function a(r){const n={a:"a",code:"code",h2:"h2",h4:"h4",hr:"hr",p:"p",pre:"pre",span:"span",...r.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.h2,{id:"inleiding",children:["Inleiding",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#inleiding",children:e.jsx(n.span,{className:"icon icon-link"})})]}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`const person = {\r
  name: "John",\r
  age: 30,\r
  isMarried: false,\r
  greet: function () {\r
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`// Declareer eerst je constructor functie:\r
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`console.log(person.name); // John\r
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`console.log(person.city); // undefined
`})}),`
`,e.jsx(n.p,{children:"Je kan ook een property verwijderen uit een object:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`delete person.isMarried;\r
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`const person1 = { name: "John" };\r
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`const today = new Date();\r
console.log(today);
`})}),`
...
`,e.jsx("img",{src:s,alt:"Timezones",className:"img-fluid my-3"})]})}function o(r={}){const{wrapper:n}=r.components||{};return n?e.jsx(n,{...r,children:e.jsx(a,{...r})}):a(r)}export{o as default};
