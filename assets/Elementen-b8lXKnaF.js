import{j as e}from"./index-tKI7b9Q5.js";function a(n){const s={a:"a",code:"code",h2:"h2",hr:"hr",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.p,{children:"Er zijn verschillende input varianten die je kan gebruiken in een invulformulier."}),`
...
`,e.jsx("div",{className:"inline-dynamic-example",children:e.jsx("input",{id:"textInput",type:"text",placeholder:"Voer hier tekst in"})}),`
`,e.jsx(s.pre,{children:e.jsxs(s.code,{className:"hljs language-html",children:[e.jsxs(s.span,{className:"hljs-tag",children:["<",e.jsx(s.span,{className:"hljs-name",children:"input"})," ",e.jsx(s.span,{className:"hljs-attr",children:"id"}),"=",e.jsx(s.span,{className:"hljs-string",children:'"textInput"'})," ",e.jsx(s.span,{className:"hljs-attr",children:"type"}),"=",e.jsx(s.span,{className:"hljs-string",children:'"text"'})," ",e.jsx(s.span,{className:"hljs-attr",children:"placeholder"}),"=",e.jsx(s.span,{className:"hljs-string",children:'"Voer hier tekst in"'})," />"]}),`
`]})}),`
`,e.jsx(s.pre,{children:e.jsxs(s.code,{className:"hljs language-js",children:[e.jsx(s.span,{className:"hljs-keyword",children:"const"})," input = ",e.jsx(s.span,{className:"hljs-variable language_",children:"document"}),".",e.jsx(s.span,{className:"hljs-title function_",children:"querySelector"}),"(",e.jsx(s.span,{className:"hljs-string",children:'"#textInput"'}),`);\r
...
`,e.jsx("div",{className:"inline-dynamic-example",children:e.jsx("input",{id:"passwordInput",type:"password",placeholder:"Voer hier je wachtwoord in"})}),`
`,e.jsx(s.pre,{children:e.jsxs(s.code,{className:"hljs language-html",children:[e.jsxs(s.span,{className:"hljs-tag",children:["<",e.jsx(s.span,{className:"hljs-name",children:"input"}),`\r
  `,e.jsx(s.span,{className:"hljs-attr",children:"id"}),"=",e.jsx(s.span,{className:"hljs-string",children:'"passwordInput"'}),`\r
...
/>`]}),`
`]})}),`
`,e.jsx(s.pre,{children:e.jsxs(s.code,{className:"hljs language-js",children:[e.jsx(s.span,{className:"hljs-keyword",children:"const"})," passwordInput = ",e.jsx(s.span,{className:"hljs-variable language_",children:"document"}),".",e.jsx(s.span,{className:"hljs-title function_",children:"querySelector"}),"(",e.jsx(s.span,{className:"hljs-string",children:'"#passwordInput"'}),`);\r
...
`,e.jsx("div",{className:"inline-dynamic-example",children:e.jsxs(s.p,{children:[e.jsx("input",{id:"checkboxInput",type:"checkbox"})," Ik ga akkoord met de voorwaarden"]})}),`
`,e.jsx(s.pre,{children:e.jsxs(s.code,{className:"hljs language-html",children:[e.jsxs(s.span,{className:"hljs-tag",children:["<",e.jsx(s.span,{className:"hljs-name",children:"input"})," ",e.jsx(s.span,{className:"hljs-attr",children:"id"}),"=",e.jsx(s.span,{className:"hljs-string",children:'"checkboxInput"'})," ",e.jsx(s.span,{className:"hljs-attr",children:"type"}),"=",e.jsx(s.span,{className:"hljs-string",children:'"checkbox"'})," />"]}),` Ik ga akkoord met de voorwaarden
`]})}),`
`,e.jsx(s.pre,{children:e.jsxs(s.code,{className:"hljs language-js",children:[e.jsx(s.span,{className:"hljs-keyword",children:"const"})," checkbox = ",e.jsx(s.span,{className:"hljs-variable language_",children:"document"}),".",e.jsx(s.span,{className:"hljs-title function_",children:"querySelector"}),"(",e.jsx(s.span,{className:"hljs-string",children:'"#checkboxInput"'}),`);\r
`,e.jsx(s.span,{className:"hljs-keyword",children:"const"})," isChecked = checkbox.",e.jsx(s.span,{className:"hljs-property",children:"checked"}),`;\r
`,e.jsx(s.span,{className:"hljs-variable language_",children:"console"}),".",e.jsx(s.span,{className:"hljs-title function_",children:"log"}),`(isChecked);
`]})}),`
