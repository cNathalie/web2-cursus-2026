import{j as e}from"./index-tKI7b9Q5.js";function a(s){const n={a:"a",code:"code",h2:"h2",hr:"hr",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"Nieuwe nodes moeten toegevoegd worden aan de DOM om zichtbaar te worden."}),`
...
`,e.jsxs("div",{className:"inline-dynamic-example",children:[e.jsx("p",{children:"Klik op de knop hieronder:"}),e.jsx("br",{}),e.jsx("p",{id:"para"})]}),`
...
`,e.jsx(n.p,{children:"Voorbeeld:"}),`
`,e.jsx("div",{className:"inline-dynamic-example",children:e.jsx("button",{id:"remove-btn",children:"Verwijder deze knop"})}),`
...
`,e.jsx(n.span,{className:"hljs-keyword",children:"const"})," btn = ",e.jsx(n.span,{className:"hljs-variable language_",children:"document"}),".",e.jsx(n.span,{className:"hljs-title function_",children:"querySelector"}),"(",e.jsx(n.span,{className:"hljs-string",children:'"#remove-btn"'}),`);\r
...
Deze `,e.jsx(n.code,{children:"<li>"})," bevat: - een tekstnode (de taak) - een verwijder‑knop"]}),`
`]}),`
`,e.jsxs(n.li,{children:[`
