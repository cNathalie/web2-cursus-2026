import Browers from "/images/browsers.png";
import NodeJs from "/images/nodejs.jpg";
import ScriptTag from "/images/script-tag.png";
...
<img src={Browers} alt="Browsers" className="img-fluid my-3" />
...
<img src={NodeJs} alt="NodeJs" className="img-fluid my-3" />
...
<img src={ScriptTag} alt="Script" className="img-fluid my-3" />
